<a href="https://colab.research.google.com/github/jaikaran109/Numpy/blob/main/BCSE0593_Lab_2_Assignment_Solution_np.ipynb" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>
...
```
You’d like to use one of the Python methods you learned in this chapter,`.upper()`, to make all the letters of every name in the
